...
<fieldset>
    <div class="well">
        ...
        <!--<div class="form-group">
            <label>Телефон</label>
            <?php/* CHtml::activeDropDownListChosen2(Tel::model(), 'id',CHtml::listData(Tel::model() -> findAll(),'id','tel'), array('style' => 'width:300px;','class' => 'select2','name' => 'CommonRule[id_tel]'), ($model -> id_tel ? array($model -> id_tel) : false), '{
						tokenSeparators: [";"],
        ...
        <div class="form-group">
            ...
            <?php
                ...
                CHtml::activeDropDownListChosen2(CommonRule::model(), 'id_section',$sections, array('style' => 'width:300px;','class' => 'select2'), $selected, '{
        ...
        <div class="form-group">
            ...
            <?php
            echo "<select name='CommonRule[prices_input][]' id='basePriceSelect' style='display: none;'>";
