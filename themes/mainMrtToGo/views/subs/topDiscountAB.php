    ...
    <div class="col-md-6 col-sm-8">
        <div class="discount-header">
            ...
            <div class="discount-content">
                ...
                <span class="discount-old-price"><?php echo round($coeff * $oldCoeff / 100 * $model -> price -> price) * 100;?>р.</span>
                <span class="discount-price"><?php echo round($coeff / 10 * $model -> price -> price) * 10;?>р.</span>
            </div>
