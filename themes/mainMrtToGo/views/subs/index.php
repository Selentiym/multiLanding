...
<div id="info2" style="display:none">
    <h2>Ананьева Наталия Исаевна (прием ведется в МДЦ «Рэмси Диагностика»)</h2><img src="<?php echo $base; ?>/img/1.jpg" alt="alt" style="float: left;margin-right: 20px;">
...
<div id="info3" style="display:none"><img src="<?php echo $base; ?>/img/2.jpg" alt="alt" style="float: left;margin-right: 20px;">
    <h2>Голимбиевская Тамара Анатольевна (прием ведется в МДЦ «Рэмси Диагностика»)</h2>
...
<div id="info5" style="display:none"><img src="<?php echo $base; ?>/img/3.jpg" alt="alt" style="float: left;margin-right: 20px;">
    <h2>Савельева Татьяна Вячеславовна (прием ведется в МДЦ «Рэмси Диагностика»)</h2>
...
<div id="info6" style="display:none">
    <h2>Макогонова Марина Евгеньевна (прием ведется в МДЦ «Рэмси Диагностика»)</h2><img src="<?php echo $base; ?>/img/4.jpg" alt="alt" style="float: left;margin-right: 20px;">
