...
<section>
    <div class="container container-shift">
        <div class="row">
            <div class="col-md-7">
                <p class="kons"><img src="<?php echo $base; ?>/img_thirdDesign/galka.png"> Консультация НЕВРОЛОГА – <b>БЕСПЛАТНО</b></p>
                <p class="kons"><img src="<?php echo $base; ?>/img_thirdDesign/galka.png"> Консультация ТРАВМАТОЛОГА  – <b>БЕСПЛАТНО</b></p>
                <p class="kons"><img src="<?php echo $base; ?>/img_thirdDesign/galka.png"> Консультация ДИАГНОСТА  – <b>БЕСПЛАТНО</b></p>
            </div>
            <div class="col-md-5">
                <p style="text-align:center;"><img style="margin-top: 5px;" src="<?php echo $base; ?>/img_thirdDesign/discount.png"></p>
            </div>
        </div>
        ...
        <div class="row we-are-best">
            <div class="col-md-6 col-sm-6">
                <img src="<?php echo $base; ?>/img_thirdDesign/best1.png"> <span>У нас лучшие врачи</span>
            </div>
            <div class="col-md-6 col-sm-6">
                <img src="<?php echo $base; ?>/img_thirdDesign/best2.png"> <span>У нас лучшее в городе <br>
					оборудование</span>
            </div>
        </div>
		
        <div class="call-me">
            <p><img src="<?php echo $base; ?>/img_thirdDesign/registration.png">Записаться на МРТ и КТ можно КРУГЛОСУТОЧНО по телефону: <b><a href="<?php echo $base; ?>/tel:88122411052"><?php echo $tel['formatted']; ?></a></b></p>
        </div>
