...
<section>
    <div class="container container-shift">
        ...
        <div class="call-me">
            <p><img src="<?php echo $base; ?>/img/registration.png">Записаться на МРТ и КТ можно КРУГЛОСУТОЧНО по телефону: <b><a href="<?php echo $base; ?>/tel:88122411952"><?php echo $tel['formatted']; ?></a></b></p>
        </div>
