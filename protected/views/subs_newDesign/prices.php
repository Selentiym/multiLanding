    ...
    <div class="container container-shift">
        <div class="navigation default" id="navigation">
            ...
            <ul>
                ...
                <li><a id="price_heart" href="#mrt-heart" title="МРТ и КТ сердца и сосудов"></a></li>
        ...
        <div class="navigation navigation-mobile" id="navigation-mobile">
            ...
            <ul>
                ...
                <li><a href="#mrt-heart" title="МРТ и КТ сердца и сосудов"></a></li>
        ...
        <div class="vrezka" style="font-size:17px;">
            <div>
                <p>Мы решили снизить цены на МРТ и КТ диагностику, сделав этот метод более доступным! В наших клиниках Вы сможете:</p>
                <ul>
                    <li><img src="<?php echo Yii::app() -> baseUrl; ?>/img_newDesign/galka.png"> найти лучшую цену в городе</li>
                    <li><img src="<?php echo Yii::app() -> baseUrl; ?>/img_newDesign/galka.png"> пройти МРТ и КТ исследование рядом с домом</li>
                </ul>
            </div>
        </div>
        <ul id="price">
