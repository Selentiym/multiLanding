        ...
        <div class="row" id="equipment">
            ...
            <div id="tabs">
                ...
                <div id="tabs_container">
                    <div id="tabs-1">
                        <img src="<?php echo Yii::app() -> baseUrl; ?>/img_newDesign/3tesla.jpg">
                        <br>
                    ...
                    <div id="tabs-2">
                        <img src="<?php echo Yii::app() -> baseUrl; ?>/img_newDesign/1.5tesla.jpg">
                    ...
                    <div id="tabs-3">
                        <img src="<?php echo Yii::app() -> baseUrl; ?>/img_newDesign/035tesla.jpg">
            ...
            <div class="col-lg-3">
                <img src="<?php echo Yii::app() -> baseUrl; ?>/img_newDesign/imgkt.png">
            </div>
...
<section>
    <div class="container container-shift">
        <div class="call-me">
            <p><img src="<?php echo Yii::app() -> baseUrl; ?>/img_newDesign/registration.png">Записаться на МРТ и/или КТ можно КРУГЛОСУТОЧНО по телефону: <b><a href="tel:88122411952">8 (812) 241-10-52</a></b></p>
        </div>
    </div>
</section>
