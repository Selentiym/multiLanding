<?php
/**
 * Copied here in order to gain ability to redefine standard CHtml functions in all the code.
 * All modifications are to be made in the descendant CHtml which lies nearby
 *
 * CHtml class file.
 *
